...
<body>
    <div class="contenedor-principal">
        <div class="cont-text" style="user-select: text">
            ...
            <div class="div-text">
                <h3>Nuevo Registro de Curso</h3>
            </div>
        </div>
        <form class="formulariologin" action="<%= request.getContextPath() %>/agregarCurso" method="Post" autocomplete="off">
            <div class="div-input">
                <input class="controls" type="number" name="nivel" placeholder="Nivel Curso" required>
                <input class="controls" type="text" name="letra" placeholder="Letra Curso" required>
            </div>
