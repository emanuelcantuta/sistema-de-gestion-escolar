...
@WebServlet(urlPatterns = {"/TablaProfesores"})
public class TablaProfesorServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(usuario != null){	
	        ...
	        RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/TablaProfesores.jsp");
